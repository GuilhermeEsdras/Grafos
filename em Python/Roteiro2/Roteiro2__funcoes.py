...
class Grafo:
    ...
    def __DFS_Auxiliar(self, vertice, verificados):
        ...
        """
        Função auxiliar à DFS que percorre o grafo recursivamente verificando se os vértices e arestas vizinhos_do_vertice
        já foram verificados, e em caso negativo, adicionando-os a lista de retorno, que representa a árvore DFS.
    ...
    def DFS(self, vertice_raiz):
        ...
        """
        Função DFS principal que retorna uma Árvore DFS do GrafoComPesos/objeto.
        :param vertice_raiz: Vértice/raiz. Ponto de partida da busca.
        :return: Uma lista representando a Árvore DFS do GrafoComPesos.
        """
