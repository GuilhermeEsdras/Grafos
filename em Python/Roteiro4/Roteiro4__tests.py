import unittest
from Roteiro4__funcoes import Grafo
...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Grafos completos
        # self.g_c = GrafoComPesos(['J', 'C', 'E', 'P'],
